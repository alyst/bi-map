#ifndef  BOOST_SERIALIZATION_UNORDERED_HPP 
#define BOOST_SERIALIZATION_UNORDERED_HPP 
...
template<class Archive, class Type, class Hasher, class Compare, class Allocator > 
inline void save( 
    Archive & ar, 
    const boost::unordered_set<Type, Hasher, Compare, Allocator> &t, 
    const unsigned int /* file_version */ 
){ 
    boost::serialization::stl::save_collection< 
        Archive, 
        boost::unordered_set<Type, Hasher, Compare, Allocator> 
    >(ar, t); 
} 
...
inline void load( 
    Archive & ar, 
    boost::unordered_set<Type, Hasher, Compare, Allocator> &t, 
    const unsigned int /* file_version */ 
){ 
    boost::serialization::stl::load_collection< 
        Archive, 
        ...
        boost::serialization::stl::archive_input_set< 
            Archive, boost::unordered_set<Type, Hasher, Compare, Allocator> >, 
            boost::serialization::stl::no_reserve_imp<boost::unordered_set< 
                Type, Hasher, Compare, Allocator 
            > 
        > 
    >(ar, t);
} 
...
#endif // BOOST_SERIALIZATION_UNORDERED_HPP
