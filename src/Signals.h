...
BOOST_CLASS_IMPLEMENTATION( CellSignalParams, object_serializable )
BOOST_IS_BITWISE_SERIALIZABLE( CellSignalParams )
...
struct ObjectsClusterSignal {
    ...
    ObjectsClusterSignal( signal_t lnScRate = unset(), signal_t scShape = 0 )
...
BOOST_CLASS_IMPLEMENTATION( ObjectsClusterSignal, object_serializable )
BOOST_IS_BITWISE_SERIALIZABLE( ObjectsClusterSignal )
