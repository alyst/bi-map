...
#include <cemm/containers/symmetric_array2d.h>
...
protected:
    ...
    void load(Archive & ar, const unsigned int version)
    {
        ...
        if ( _blockIsNoiseLLHValid ) {
            ...
            _blockIsNoiseLLH.reset( objectsClusters().size(), probesClusters().size(), cemm::math::unset<log_prob_t>() );
        }
        ...
        if ( _blockIsSignalLLHValid ) {
            ...
            _blockIsSignalLLH.reset( objectsClusters().size(), probesClusters().size(), cemm::math::unset<log_prob_t>() );
        }
...
inline void save_construct_data(
    Archive & ar, const cemm::bimap::ChessboardBiclusteringFit* t, const unsigned int file_version
){
...
inline void load_construct_data(
    Archive & ar, cemm::bimap::ChessboardBiclusteringFit* t, const unsigned int file_version
){
    ...
    ::new(t)cemm::bimap::ChessboardBiclusteringFit( *pPrecomputed, *pPriors );
}

} }

BOOST_CLASS_IMPLEMENTATION( cemm::bimap::ChessboardBiclusteringEnergyEval, object_serializable )
BOOST_CLASS_TRACKING( cemm::bimap::ChessboardBiclusteringEnergyEval, track_never )

BOOST_CLASS_IMPLEMENTATION( cemm::bimap::ChessboardBiclusteringFit, object_serializable )

BOOST_CLASS_IMPLEMENTATION( cemm::bimap::StaticChessboardBiclustering, object_serializable )
BOOST_CLASS_TRACKING( cemm::bimap::StaticChessboardBiclustering, track_never )
