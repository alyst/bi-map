...
public:
    ...
    {
        blockEnablementPrior = BernoulliDistribution( cellEnablementProb );
...
BOOST_IS_BITWISE_SERIALIZABLE( cemm::bimap::ChessboardBiclusteringDerivedPriors )
BOOST_CLASS_VERSION( cemm::bimap::ChessboardBiclusteringDerivedPriors, 1 );

BOOST_CLASS_IMPLEMENTATION( cemm::bimap::ChessboardBiclusteringPriors, object_serializable )
//BOOST_IS_BITWISE_SERIALIZABLE( ChessboardBiclusteringPriors )

BOOST_IS_BITWISE_SERIALIZABLE( cemm::bimap::ChessboardBiclusteringHyperPriors )

BOOST_CLASS_VERSION( cemm::bimap::ChessboardBiclusteringData, 1 )
