...
#include "cemm/bimap/ChessboardBiclusteringMetrics.h"
...
BOOST_CLASS_VERSION( cemm::bimap::BIMAPWalk, 1 );
BOOST_CLASS_VERSION( cemm::bimap::BIMAPWalk::BIMAPPriorParamsStep, 1 );
